...
import { createLinkSocialMedia } from "@/xyz-panel/api/link-social-media"
import { schemaLinkSocialMediaRequest, type SchemaLinkSocialMediaRequest } from "@/xyz-panel/types/link-social-media"
...
const Add = ({ show, onClose }: { show: boolean, onClose: (refreshData?: boolean) => void }) => {
    ...
    const onSubmit = async (data: SchemaLinkSocialMediaRequest) => {
        try {
            ...
            await createLinkSocialMedia(data)
