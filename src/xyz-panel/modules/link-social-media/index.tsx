...
const LinkSocialMedia = () => {
  const [linkSocialMediaList, setLinkSocialMediaList] = useState<
    SchemaLinkSocialMediaData[]
  >([]);
  ...
  async function getDataLinkSocialMedia() {
    try {
      toggleLoading(true, "Loading link social media...");
      ...
      const message =
        error instanceof Error
          ? error.message
          : "Gagal memuat data link social media";
  ...
  async function handleDelete() {
    try {
      ...
      const message =
        error instanceof Error
          ? error.message
          : "Gagal menghapus data link social media";
      toggleToast(true, message, "error");
    } finally {
      toggleLoading(false);
      setIdForDelete(null);
