...
const Team = () => {
    ...
    async function getDataTeam() {
        try {
            toggleLoading(true, "Lagi ngambil data team...")
            const response = await getTeam()
            setTeamList(response.data)
        } catch (error) {
            const message = error instanceof Error ? error.message : "Gagal memuat data team"
    ...
    async function handleDelete() {
        try {
            ...
            const message = error instanceof Error ? error.message : "Gagal menghapus data team"
            toggleToast(true, message, "error")
        } finally {
            toggleLoading(false)
            setIdForDelete(null)
    ...
    return (
        <>
            <Helmet>
                <title>Teams - X-LABS.my.id | Inovasi dan Pengembangan Aplikasi Mobile</title>
            </Helmet>
