...
import { updateTeam } from "@/xyz-panel/api/team"
import { schemaTeamRequest, type SchemaTeamData, type SchemaTeamRequest } from "@/xyz-panel/types/team"
...
const Edit = (
    ...
    const onSubmit = async (data: SchemaTeamRequest) => {
        try {
            ...
            await updateTeam(detail.guid, data)
    ...
    return (
        <Modal show={show} title="Edit Team" onClose={() => onClose(false)}>
